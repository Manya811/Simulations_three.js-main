...
//   LOADING base
  new THREE.MTLLoader(manager).load(
    "./resources/ac genrator.mtl",
    function (materials) {
      materials.preload();

      new THREE.OBJLoader(manager)
        .setMaterials(materials)
        .load("./resources/ac genrator.obj", function (object) {
...
//     mesh = new THREE.Mesh( geo, mat );
    ...
    mesh.position.set(0.015,0.1,0.1);
    mesh.rotation.x = -0.3;
    ...
    function animate() {
        ...
        mesh.rotation.z = 0.35 * Math.cos(coil.rotation.z);
        // pts[1].y += 0.01;
        // console.log(mesh.geometry.parameters.path.points[1].z)
        // mesh.geometry.parameters.path.points[1].z += 0.11;
        // mesh.geometry.verticesNeedUpdate = true;
        // mesh.geometry.dynamic = true;
        // geo.dynamic = true;
        if(settings.isRunning){
         coil.rotation.z -= 0.1 * settings.speed;
        }
