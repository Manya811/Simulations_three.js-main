...
import { DragControls } from 'https://cdn.jsdelivr.net/npm/three@0.121.1/examples/jsm/controls/DragControls.js';
 ...
 function VectorField(options){
    ...
    function init() {
        ...
        pane = new Tweakpane.Pane({container:document.getElementById("gui"),title:"Cell",expanded: true});
       ...
       // pane.addButton({title:"Reset"}).on('click',reset);
        ...
        // light
        var light = new THREE.DirectionalLight( 0xaaaaaa, 5);
        ...
        // var bulb = new THREE.PointLight( 'red', 10);
        // bulb.position.set(-0.09341,0.06411,0.46361)
        // scene.add(bulb);
  ...
  new THREE.MTLLoader(manager).load(
    "./resources/Simple Electrical Cell.mtl",
    function (materials) {
      materials.preload();

      new THREE.OBJLoader(manager)
        .setMaterials(materials)
        .load("./resources/Simple Electrical Cell.obj", function (object) {
        ...
        cell = object;
        scene.add(cell);
        // var spotlight = new THREE.SpotLight('red',10);
        // spotlight.position.set(-0.09341+0.01,0.06411+0.01,0.46361+0.01)
        // spotlight.lookAt(-0.09341,0.06411,0.46361);
        // scene.add(spotlight);
